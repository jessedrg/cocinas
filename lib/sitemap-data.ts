// =============================================================================
// SITEMAP DATA - REFORMAS DE COCINA
// =============================================================================
// Reformas de cocina en España - 8118 municipalities
// =============================================================================
...
// =============================================================================
// HIGH-INTENT KEYWORD MODIFIERS - Sector Reformas de Cocina
// =============================================================================
export const MODIFIERS = [
  ...
  // ============ URGENCIA / VELOCIDAD ============
  "-rapida", "-urgente", "-express", "-en-una-semana",
  ...
  // ============ TIPO DE SERVICIO ============
  "-llave-en-mano", "-integral", "-completa", "-parcial",
  "-sin-obras",

  // ============ ESTILO ============
  "-moderna", "-minimalista", "-rustica", "-vintage",
  "-nordica", "-industrial",

  // ============ TAMAÑO ============
  "-pequena", "-grande", "-abierta", "-americana",

  // ============ MATERIAL ============
  "-madera", "-lacada", "-silestone", "-dekton",
  "-granito", "-corian",
  ...
  // ============ COMBOS ============
  "-economica-integral", "-moderna-llave-en-mano",
] as const;
...
export const PROBLEMS: Record<Service, readonly string[]> = {
  "reforma-cocina": [
    "cocina-antigua", "cocina-obsoleta", "falta-espacio",
    "humedades-cocina", "cocina-oscura", "distribucion-mala",
  ],
  "cocina-a-medida": [
    "espacio-irregular", "necesito-mas-almacenaje", "cocina-en-l",
    "cocina-en-u", "isla-central",
  ],
  "muebles-cocina": [
    "muebles-rotos", "cambiar-puertas", "muebles-altos",
    "muebles-bajos", "columna-despensa",
  ],
  "encimera-cocina": [
    "encimera-rota", "cambiar-encimera", "encimera-manchada",
    "encimera-quemada",
  ],
  "cocina-moderna": [
    "modernizar-cocina", "actualizar-cocina", "cocina-anos-80",
    "cocina-desfasada",
  ],
  "cocina-integral": [
    "reforma-total", "empezar-de-cero", "cambiar-todo",
    "nueva-cocina-completa",
  ],
  "diseno-cocina": [
    "no-se-como-distribuir", "ideas-cocina", "proyecto-cocina",
    "necesito-disenador",
  ],
  "cocina-pequena": [
    "poco-espacio", "cocina-mini", "optimizar-espacio",
    "cocina-estudio",
  ],
  "instalacion-cocina": [
    "montar-cocina", "instalar-muebles", "fontaneria-cocina",
    "electricidad-cocina",
  ],
  "cocina-industrial": [
    "cocina-restaurante", "cocina-profesional", "cocina-hosteleria",
